...
handler404 = 'ecom.views.page_not_found_view'
...
urlpatterns = [
    ...
    path('admincreate', views.create_admin_view, name='admin-create'),
    ...
    path('download-certificate/<int:orderID>/<int:productID>/', views.download_certificate_view, name='download_certificate'),
